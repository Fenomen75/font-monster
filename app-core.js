...
function renderFonts(){
  ...
  // 20 kart birdən-birə DOM-a yazılanda qlobal tooltip MutationObserver-i hər kart
  // üçün ayrıca tetiklənib reload sonrası bir neçə saniyəlik donmaya səbəb olurdu.
  // İndi observer bütün kartlar yazılana qədər dayandırılır, sonra TƏK dəfə
  // grid üzərində stripTitles işlədilir.
  if(typeof window._fmWithObserverPaused==='function'){
    window._fmWithObserverPaused(_buildCards, grid);
  } else {
    _buildCards();
  }
