...
function _detailRenderHeader(font, dlCount, licM){
  ...
  document.getElementById('fdpHero').innerHTML=`
    ...
    <div class="fdp-actions">
      ...
      <button class="fdp-like" onclick="adminDeleteFontFromDetail('${font.id}','${font.name.replace(/'/g,"\'")}')" title="Delete font (admin)" style="color:var(--red,#ff3b30);background:rgba(255,59,48,0.1);border-color:rgba(255,59,48,0.25)" id="fdpDeleteBtn_${font.id}">
